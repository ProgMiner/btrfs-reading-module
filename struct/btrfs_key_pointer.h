...
static inline u64 btrfs_key_pointer_blocknr(const struct btrfs_key_pointer * key_pointer) {
    return le64_to_cpu(key_pointer->blocknr);
}

static inline u64 btrfs_key_pointer_generation(const struct btrfs_key_pointer * key_pointer) {
