...
static inline u64 btrfs_stripe_devid(const struct btrfs_stripe * stripe) {
    return le64_to_cpu(stripe->devid);
}

static inline u64 btrfs_stripe_offset(const struct btrfs_stripe * stripe) {
